...
aws_ec2=$(python scripts/buildscripts/aws_ec2.py \
...
do
  ec2_value=$(python scripts/buildscripts/yaml_key_value.py --yamlFile $aws_ec2_status_yml --yamlKey $ec2_attribute)
