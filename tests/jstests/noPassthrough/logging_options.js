...
expectedResult = {
    "parsed":
        {"config": "tests/jstests/libs/config_files/set_verbosity.json", "systemLog": {"verbosity": 5}}
};
testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/set_verbosity.json"}, expectedResult);

// log component verbosity
jsTest.log("Testing \"systemLog.component.verbosity\" config file option");
expectedResult = {
    "parsed": {
        "config": "tests/jstests/libs/config_files/set_component_verbosity.json",
        "systemLog": {
            "verbosity": 2,
            "component": {
...
testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/set_component_verbosity.json"},
                         expectedResult);
