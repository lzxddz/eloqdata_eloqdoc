...
// test config file
var m2 = MongoRunner.runMongod({config: "tests/jstests/libs/testconfig"});

var m2expected = {
    "parsed": {
        "config": "tests/jstests/libs/testconfig",
...
var m3 = MongoRunner.runMongod({config: "tests/jstests/libs/testconfig"});
