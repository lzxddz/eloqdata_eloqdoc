...
(function() {
    ...
    load("tests/jstests/replsets/rslib.js");           // For startSetIfSupportsReadMajority.
    load("tests/jstests/libs/change_stream_util.js");  // For ChangeStreamTest.
    load("tests/jstests/libs/namespace_utils.js");     // For getCollectionNameFromFullNamespace.
    load("tests/jstests/libs/write_concern_util.js");  // For stopReplicationOnSecondaries.
