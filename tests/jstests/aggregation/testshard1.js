...
load('tests/jstests/aggregation/extras/utils.js');
load('tests/jstests/libs/analyze_plan.js');  // For planHasStage.
...
jsTestLog('running tests/jstests/aggregation/bugs/server9444.js');
load("tests/jstests/aggregation/bugs/server9444.js");  // external sort
jsTestLog('running tests/jstests/aggregation/bugs/server11675.js');
load("tests/jstests/aggregation/bugs/server11675.js");  // text support
