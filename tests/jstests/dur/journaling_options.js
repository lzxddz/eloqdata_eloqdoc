...
function doTest() {
    ...
    expectedResult = {
        "parsed": {
            "config": "tests/jstests/libs/config_files/enable_journal.json",
            "storage": {"journal": {"enabled": false}}
        }
    };
    testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/enable_journal.json"},
                             expectedResult);
    ...
    expectedResult = {
        "parsed": {
            "config": "tests/jstests/libs/config_files/disable_journal.ini",
            "storage": {"journal": {"enabled": false}}
        }
    };
    testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/disable_journal.ini"},
                             expectedResult);

    jsTest.log("Testing explicitly disabled \"nojournal\" config file option");
    expectedResult = {
        "parsed": {
            "config": "tests/jstests/libs/config_files/disable_nojournal.ini",
            "storage": {"journal": {"enabled": true}}
        }
    };
    testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/disable_nojournal.ini"},
                             expectedResult);

    jsTest.log("Testing explicitly disabled \"dur\" config file option");
    expectedResult = {
        "parsed": {
            "config": "tests/jstests/libs/config_files/disable_dur.ini",
            "storage": {"journal": {"enabled": false}}
        }
    };
    testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/disable_dur.ini"}, expectedResult);

    jsTest.log("Testing explicitly disabled \"nodur\" config file option");
    expectedResult = {
        "parsed": {
            "config": "tests/jstests/libs/config_files/disable_nodur.ini",
            "storage": {"journal": {"enabled": true}}
        }
    };
    testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/disable_nodur.ini"},
                             expectedResult);
    ...
    expectedResult = {
        "parsed": {
            "config": "tests/jstests/libs/config_files/implicitly_enable_journal.ini",
            "storage": {"journal": {"enabled": true}}
        }
    };
    testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/implicitly_enable_journal.ini"},
                             expectedResult);

    jsTest.log("Testing implicitly enabled \"nojournal\" config file option");
    expectedResult = {
        "parsed": {
            "config": "tests/jstests/libs/config_files/implicitly_enable_nojournal.ini",
            "storage": {"journal": {"enabled": false}}
        }
    };
    testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/implicitly_enable_nojournal.ini"},
                             expectedResult);

    jsTest.log("Testing implicitly enabled \"dur\" config file option");
    expectedResult = {
        "parsed": {
            "config": "tests/jstests/libs/config_files/implicitly_enable_dur.ini",
            "storage": {"journal": {"enabled": true}}
        }
    };
    testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/implicitly_enable_dur.ini"},
                             expectedResult);

    jsTest.log("Testing implicitly enabled \"nodur\" config file option");
    expectedResult = {
        "parsed": {
            "config": "tests/jstests/libs/config_files/implicitly_enable_nodur.ini",
            "storage": {"journal": {"enabled": false}}
        }
    };
    testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/implicitly_enable_nodur.ini"},
                             expectedResult);
