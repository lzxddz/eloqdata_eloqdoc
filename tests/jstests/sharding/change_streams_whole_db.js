...
(function() {
    ...
    load('tests/jstests/replsets/libs/two_phase_drops.js');  // For TwoPhaseDropCollectionTest.
    load('tests/jstests/aggregation/extras/utils.js');       // For assertErrorCode().
    load('tests/jstests/libs/change_stream_util.js');        // For ChangeStreamTest.
    load("tests/jstests/libs/collection_drop_recreate.js");  // For assertDropCollection.

    // For supportsMajorityReadConcern().
    load("tests/jstests/multiVersion/libs/causal_consistency_helpers.js");
