...
(function() {
    const tzGoodInfo = "tests/jstests/libs/config_files/good_timezone_info";
    const tzBadInfo = "tests/jstests/libs/config_files/bad_timezone_info";
    const tzNoInfo = "tests/jstests/libs/config_files/missing_directory";
