...
expectedResult = {
    "parsed": {
        "config": "tests/jstests/libs/config_files/enable_paranoia.json",
        "sharding": {"archiveMovedChunks": true}
    }
};
testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/enable_paranoia.json"},
                         expectedResult);
...
expectedResult = {
    "parsed": {
        "config": "tests/jstests/libs/config_files/set_shardingrole.json",
        "sharding": {"clusterRole": "configsvr"}
    }
};
testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/set_shardingrole.json"},
                         expectedResult);
...
expectedResult = {
    "parsed": {
        "config": "tests/jstests/libs/config_files/disable_moveparanoia.ini",
        "sharding": {"archiveMovedChunks": false}
    }
};
testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/disable_moveparanoia.ini"},
                         expectedResult);

jsTest.log("Testing explicitly disabled \"noMoveParanoia\" config file option");
expectedResult = {
    "parsed": {
        "config": "tests/jstests/libs/config_files/disable_nomoveparanoia.ini",
        "sharding": {"archiveMovedChunks": true}
    }
};
testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/disable_nomoveparanoia.ini"},
                         expectedResult);
