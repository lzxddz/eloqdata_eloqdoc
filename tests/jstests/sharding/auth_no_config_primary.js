...
(function() {
    ...
    var st = new ShardingTest(
        {shards: 1, other: {keyFile: 'tests/jstests/libs/key1', shardAsReplicaSet: false}});
    ...
    var otherMongos =
        MongoRunner.runMongos({keyFile: "tests/jstests/libs/key1", configdb: st.s.savedOptions.configdb});
