...
(function() {
    ...
    load("tests/jstests/libs/profiler.js");   // For profilerHas*OrThrow() helpers.
    load("tests/jstests/replsets/rslib.js");  // For reconfig().

    // For stopServerReplication() and restartServerReplication().
    load("tests/jstests/libs/write_concern_util.js");
    ...
    const joinResumeReplicationShell =
        startParallelShell(`load('tests/jstests/libs/write_concern_util.js');
