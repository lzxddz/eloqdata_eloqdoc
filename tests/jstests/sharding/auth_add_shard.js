...
(function() {
    ...
    var st = new ShardingTest(
        {shards: 1, mongos: 1, other: {keyFile: 'tests/jstests/libs/key1', shardAsReplicaSet: false}});
    ...
    var conn = MongoRunner.runMongod({keyFile: "tests/jstests/libs/key1", shardsvr: ""});
