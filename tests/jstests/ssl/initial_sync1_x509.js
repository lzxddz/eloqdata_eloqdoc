...
var common_options = {
    ...
    sslMode: "requireSSL",
    sslPEMKeyFile: "tests/jstests/libs/server.pem",
    sslCAFile: "tests/jstests/libs/ca.pem",
...
var x509_options1 = Object.merge(
    common_options, {sslClusterFile: "tests/jstests/libs/cluster_cert.pem", clusterAuthMode: "x509"});
...
x509_options1 = Object.merge(
    common_options,
    {sslClusterFile: "tests/jstests/libs/cluster_cert.pem", clusterAuthMode: "sendX509", auth: ""});
...
x509_options2 = Object.merge(common_options,
                             {sslClusterFile: "tests/jstests/libs/smoke.pem", clusterAuthMode: "x509"});
