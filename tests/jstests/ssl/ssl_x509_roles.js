...
load('tests/jstests/ssl/libs/ssl_helpers.js');

(function() {
    "use strict";

    const SERVER_CERT = "tests/jstests/libs/server.pem";
    const CA_CERT = "tests/jstests/libs/ca.pem";
    const CLIENT_CERT = "tests/jstests/libs/client_roles.pem";
    const CLIENT_ESCAPE_CERT = "tests/jstests/libs/client_escape.pem";
    const CLIENT_UTF8_CERT = "tests/jstests/libs/client_utf8.pem";
    const CLIENT_EMAIL_CERT = "tests/jstests/libs/client_email.pem";
    const CLIENT_TITLE_CERT = "tests/jstests/libs/client_title.pem";
    ...
    function authAndTest(port) {
        const mongo = runMongoProgram("mongo",
                                      ...
                                      "--sslPEMKeyFile",
                                      CLIENT_CERT,
                                      "tests/jstests/ssl/libs/ssl_x509_role_auth.js");
        ...
        const escaped = runMongoProgram("mongo",
                                        ...
                                        "--sslPEMKeyFile",
                                        CLIENT_ESCAPE_CERT,
                                        "tests/jstests/ssl/libs/ssl_x509_role_auth_escape.js");
        ...
        const utf8 = runMongoProgram("mongo",
                                     ...
                                     "--sslPEMKeyFile",
                                     CLIENT_UTF8_CERT,
                                     "tests/jstests/ssl/libs/ssl_x509_role_auth_utf8.js");
        ...
        const email = runMongoProgram("mongo",
                                      ...
                                      "--sslPEMKeyFile",
                                      CLIENT_EMAIL_CERT,
                                      "tests/jstests/ssl/libs/ssl_x509_role_auth_email.js");
    ...
    print("2. Testing x.509 auth to mongos");
    {
        ...
        let st = new ShardingTest({
            ...
            mongos: 1,
            other: {
                keyFile: 'tests/jstests/libs/key1',
