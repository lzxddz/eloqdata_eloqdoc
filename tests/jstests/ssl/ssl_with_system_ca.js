// On OSX this test assumes that tests/jstests/libs/trusted-ca.pem has been added as a trusted
...
//   security add-trusted-cert -d tests/jstests/libs/trusted-ca.pem
(function() {
    'use strict';
    ...
    function testWithCerts(prefix) {
        ...
        const conn = MongoRunner.runMongod(
            {sslMode: 'allowSSL', sslPEMKeyFile: 'tests/jstests/libs/' + prefix + 'server.pem'});
        ...
        let argv = [
            ...
            conn.port,
            '--sslPEMKeyFile',
            'tests/jstests/libs/' + prefix + 'client.pem',
            '--eval',
            ';'
        ];
        ...
        if (HOST_TYPE == "linux") {
            ...
            argv.unshift("env", "SSL_CERT_FILE=tests/jstests/libs/trusted-ca.pem");
        }
