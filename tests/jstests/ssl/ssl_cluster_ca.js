...
(function() {
    ...
    const valid_options = {
        ...
        sslPEMKeyFile: 'tests/jstests/libs/trusted-server.pem',
        sslCAFile: 'tests/jstests/libs/trusted-ca.pem',
        ...
        sslClusterFile: 'tests/jstests/libs/server.pem',
        sslClusterCAFile: 'tests/jstests/libs/ca.pem',
    ...
    testConnect('tests/jstests/libs/client.pem', true);
    testConnect('tests/jstests/libs/trusted-client.pem', false);
