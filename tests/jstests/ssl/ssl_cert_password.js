...
requireSSLProvider('openssl', function() {
    ...
    var md = MongoRunner.runMongod({
        ...
        dbpath: dbpath,
        sslMode: "requireSSL",
        sslPEMKeyFile: "tests/jstests/libs/password_protected.pem",
    ...
    var exit_code = runMongoProgram("mongo",
                                    ...
                                    "--sslCAFile",
                                    "tests/jstests/libs/ca.pem",
                                    "--sslPEMKeyFile",
                                    "tests/jstests/libs/password_protected.pem",
                                    "--sslPEMKeyPassword",
                                    "barf");
    ...
    source_filename = 'tests/jstests/ssl/ssl_cert_password.js';
