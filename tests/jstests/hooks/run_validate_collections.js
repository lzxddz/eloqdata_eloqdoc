...
(function() {
    load('tests/jstests/libs/discover_topology.js');      // For Topology and DiscoverTopology.
    load('tests/jstests/hooks/validate_collections.js');  // For CollectionValidator.
