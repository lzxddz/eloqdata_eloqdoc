...
(function() {
    ...
    load("tests/jstests/libs/write_concern_util.js");             // assertWriteConcernError
    load("tests/jstests/replsets/rslib.js");                      // reconfig
    load("tests/jstests/libs/feature_compatibility_version.js");  // latestFCV/lastStableFCV
