 ...
 * (preferSSL), sslPEMKeyFile ("tests/jstests/libs/server.pem"), and sslCAFile
...
function SSLTest(serverOpts, clientOpts) {
    var canonicalServerOpts = function(userProvidedOpts) {
        ...
        if (!canonical.hasOwnProperty("sslPEMKeyFile")) {
            canonical.sslPEMKeyFile = "tests/jstests/libs/server.pem";
        }
        if (!canonical.hasOwnProperty("sslCAFile")) {
            canonical.sslCAFile = "tests/jstests/libs/ca.pem";
        }
        return canonical;
    };
...
SSLTest.prototype.defaultSSLClientOptions = {
    "ssl": "",
    "sslPEMKeyFile": "tests/jstests/libs/client.pem",
