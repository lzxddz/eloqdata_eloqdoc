...
(function() {
    ...
    load("tests/jstests/libs/command_sequence_with_retries.js");  // for CommandSequenceWithRetries
    ...
    MongoRunner.validateCollectionsCallback = function(port) {
        ...
        load('tests/jstests/hooks/validate_collections.js');  // for validateCollections
