...
load('tests/jstests/concurrency/fsm_libs/assert.js');
load('tests/jstests/concurrency/fsm_libs/cluster.js');       // for Cluster.isStandalone
load('tests/jstests/concurrency/fsm_libs/parse_config.js');  // for parseConfig
load('tests/jstests/libs/specific_secondary_reader_mongo.js');
        ...
        try {
            ...
            if (Cluster.isReplication(args.clusterOptions)) {
                if (args.clusterOptions.hasOwnProperty('sharded') &&
                    ...
                    load('tests/jstests/libs/override_methods/auto_retry_on_network_error.js');
                }
                ...
                load('tests/jstests/libs/override_methods/implicitly_retry_on_database_drop_pending.js');
            }

            if (TestData.defaultReadConcernLevel || TestData.defaultWriteConcern) {
                load('tests/jstests/libs/override_methods/set_read_and_write_concerns.js');
            }
