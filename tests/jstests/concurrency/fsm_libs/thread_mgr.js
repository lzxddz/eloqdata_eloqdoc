...
load('tests/jstests/concurrency/fsm_libs/worker_thread.js');  // for workerThread
...
workerThread.fsm = function(workloads, args, options) {
    load('tests/jstests/concurrency/fsm_libs/worker_thread.js');  // for workerThread.main
    load('tests/jstests/concurrency/fsm_libs/fsm.js');            // for fsm.run
...
workerThread.composed = function(workloads, args, options) {
    load('tests/jstests/concurrency/fsm_libs/worker_thread.js');  // for workerThread.main
    load('tests/jstests/concurrency/fsm_libs/composer.js');       // for composer.run
