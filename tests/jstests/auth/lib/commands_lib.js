...
See tests/jstests/auth/commands_builtinRoles.js and
tests/jstests/auth/commands_userDefinedRoles.js for two separate implementations
...
load("tests/jstests/libs/uuid_util.js");
// For isReplSet
load("tests/jstests/libs/fixture_helpers.js");
