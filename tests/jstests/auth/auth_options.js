...
expectedResult = {
    "parsed": {
        "config": "tests/jstests/libs/config_files/enable_auth.json",
        "security": {"authorization": "enabled"}
    }
};
testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/enable_auth.json"}, expectedResult);
...
expectedResult = {
    "parsed": {
        "config": "tests/jstests/libs/config_files/disable_auth.ini",
        "security": {"authorization": "disabled"}
    }
};
testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/disable_auth.ini"}, expectedResult);

jsTest.log("Testing explicitly disabled \"noauth\" config file option");
expectedResult = {
    "parsed": {
        "config": "tests/jstests/libs/config_files/disable_noauth.ini",
        "security": {"authorization": "enabled"}
    }
};
testGetCmdLineOptsMongod({config: "tests/jstests/libs/config_files/disable_noauth.ini"}, expectedResult);
