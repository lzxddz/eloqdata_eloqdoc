...
void createIndexForApplyOps(OperationContext* opCtx,
    ...
    std::shared_ptr<Database> db = DatabaseHolder::getDatabaseHolder().get(opCtx, indexNss.ns());
...
Status applyCommand_inlock(OperationContext* opCtx,
    ...
    {
        std::shared_ptr<Database> db = DatabaseHolder::getDatabaseHolder().get(opCtx, nss.ns());
